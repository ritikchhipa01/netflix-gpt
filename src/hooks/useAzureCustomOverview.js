...
import { addOverview } from '../utils/translateSlice';
const { v4: uuidv4 } = require('uuid');

const useAzureTCustomOverview = () => {
    const dispatch = useDispatch();
    const text = useSelector(store => store.movies.movieOverview)
...
export default useAzureTCustomOverview;